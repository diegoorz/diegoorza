              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:diegoorozcoclouthier@gmail.com" className="text-blue-200 hover:text-white transition-colors">
                      diegoorozcoclouthier@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+523327208312" className="text-blue-200 hover:text-white transition-colors">
                      +52 332 720 8312
                    </a>
                  </div>
                </div>
          ...
          <div>
            <form className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="bg-blue-800 hover:bg-blue-900 text-white py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 w-full sm:w-auto"
                >
                  Enviar Mensaje
                </button>
              </div>
